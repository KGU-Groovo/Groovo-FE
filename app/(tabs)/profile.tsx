...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#240529' }, content: { padding: 24, paddingBottom: 120, gap: 20 },
  profile: { borderRadius: 32, backgroundColor: '#2A0642', borderWidth: 1, borderColor: '#A50071', alignItems: 'center', padding: 24, gap: 9 }, avatarWrap: { position: 'relative' }, avatar: { width: 96, height: 96, borderRadius: 48, borderWidth: 2, borderColor: '#FF43BD' }, tierBadge: { position: 'absolute', right: -3, bottom: 0, width: 25, height: 25, borderRadius: 13, backgroundColor: '#FF43BD', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#2A0642' }, name: { color: '#FFF', fontSize: 23, fontWeight: '800' }, tier: { color: '#F6C6DF', fontSize: 12, letterSpacing: 1.5 },
  counts: { width: '100%', flexDirection: 'row', justifyContent: 'space-around', borderTopWidth: 1, borderTopColor: '#4A285C', paddingTop: 18, marginTop: 5 }, count: { color: '#F8BADF', textAlign: 'center', fontSize: 18, fontWeight: '700' }, countLabel: { color: '#FFF', fontSize: 12, marginTop: 4 }, edit: { width: '100%', borderRadius: 28, backgroundColor: '#D800C6', padding: 14, alignItems: 'center', marginTop: 7 }, editText: { color: '#FFF', fontWeight: '800' },
  sectionTabs: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#512A55' }, sectionTab: { flex: 1, alignItems: 'center', paddingVertical: 12 }, activeTab: { borderBottomWidth: 2, borderBottomColor: '#FF43BD' }, sectionTabText: { color: '#BFA7BE', fontSize: 15, fontWeight: '700' }, activeTabText: { color: '#FFF' },
  videoSection: { gap: 12 }, featuredVideo: { height: 260, borderRadius: 24, overflow: 'hidden', justifyContent: 'flex-end' }, featuredImage: { ...StyleSheet.absoluteFillObject, width: undefined, height: undefined }, featuredShade: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(18, 0, 22, .42)' }, featuredCopy: { padding: 18, gap: 4 }, featuredLabel: { color: '#FFC4E8', fontSize: 12, fontWeight: '800' }, featuredTitle: { color: '#FFF', fontSize: 24, fontWeight: '800' }, featuredPlay: { position: 'absolute', right: 16, bottom: 16, width: 46, height: 46, borderRadius: 23, backgroundColor: '#FF43BD', alignItems: 'center', justifyContent: 'center' }, recentVideo: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 10, borderRadius: 18, backgroundColor: '#351139' }, recentImage: { width: 68, height: 68, borderRadius: 12 }, recentCopy: { flex: 1, gap: 5 }, cardTitle: { color: '#F7E9F6', fontSize: 15, fontWeight: '700' }, meta: { color: '#F1CCE9', fontSize: 13 },
  favoriteList: { gap: 12 }, favorite: { flexDirection: 'row', alignItems: 'center', gap: 13, padding: 12, borderRadius: 18, backgroundColor: '#351139' }, favoriteCover: { width: 62, height: 62, borderRadius: 12 }, favoriteCopy: { flex: 1, gap: 4 }, notes: { color: '#FFB55A', fontSize: 15, letterSpacing: 2 },
  sheetBackdrop: { flex: 1, justifyContent: 'flex-end' }, sheetMask: { ...StyleSheet.absoluteFillObject, backgroundColor: '#000' }, sheetDismiss: { ...StyleSheet.absoluteFillObject }, sheet: { borderTopLeftRadius: 30, borderTopRightRadius: 30, overflow: 'hidden', backgroundColor: '#25122A' }, sheetHandle: { alignSelf: 'center', width: 42, height: 5, borderRadius: 3, backgroundColor: '#B9A9BC', marginVertical: 10 }, sheetPreview: { height: 390, justifyContent: 'space-between', padding: 26, paddingBottom: 34 }, sheetImage: { opacity: .6, resizeMode: 'cover' }, sheetOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(15,0,20,.26)' }, sheetSongInfo: { flexDirection: 'row', alignItems: 'center', gap: 14 }, artwork: { width: 76, height: 76, borderRadius: 8 }, sheetTitle: { color: '#FFF', fontSize: 22, fontWeight: '900' }, sheetArtist: { color: '#E0D6E3', marginTop: 6, letterSpacing: 1.4 }, sheetPlay: { backgroundColor: '#D800C6', borderRadius: 10, paddingVertical: 15, alignItems: 'center' }, sheetPlayText: { color: '#FFF', fontSize: 19, fontWeight: '900' },
});
