...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#151820' }, 
  topBar: { paddingHorizontal: 24, paddingBottom: 18, gap: 18 }, 
  content: { paddingHorizontal: 24, paddingBottom: 120, gap: 18 }, 
  header: { flexDirection: 'row', alignItems: 'center', gap: 10 }, 
  title: { color: '#FFF', fontSize: 24, fontWeight: '800' },
  search: { borderRadius: 14, height: 48, backgroundColor: '#242831', alignItems: 'center', flexDirection: 'row', gap: 10, paddingHorizontal: 16 }, 
  searchText: { color: '#C7CCD6' }, 
  filters: { gap: 8 }, 
  filter: { borderRadius: 12, paddingHorizontal: 17, paddingVertical: 10, backgroundColor: '#242831', borderWidth: 1, borderColor: '#3E4552' }, 
  selectedFilter: { backgroundColor: '#351139', borderColor: '#FF43BD' }, 
  filterText: { color: '#C7CCD6', fontWeight: '700' }, 
  selectedText: { color: '#FFF' },
  lesson: { overflow: 'hidden', borderRadius: 16, backgroundColor: '#242831', borderWidth: 1, borderColor: '#3E4552' }, 
  lessonImage: { width: '100%', height: 172, opacity: .78 }, 
  lessonBody: { padding: 14, gap: 10 }, 
  lessonTitleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, 
  lessonTitle: { color: '#F7F8FA', fontSize: 20, fontWeight: '800' }, 
  level: { color: '#FFD1E8', backgroundColor: '#4B1745', paddingHorizontal: 8, paddingVertical: 3, fontSize: 11 }, 
  meta: { color: '#C7CCD6' }, 
  start: { borderRadius: 7, backgroundColor: '#D800C6', alignItems: 'center', padding: 11 }, 
